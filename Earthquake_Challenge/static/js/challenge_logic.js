...
// We create a fourth layer that will be the background of our map.
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(tectonicData) {
    //Adding Style info for Tectonic plates
  ...
  // Create a GeoJSON layer with tectonic Plate data.
  L.geoJson(tectonicData, {
    ...
    // Adding Style to tectonic plate lines.
  style: TectonicStyle,
